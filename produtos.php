...
<body>
    ...
    <div class="container">
        <div class="container text-center mb-4 mt-4">
            ...
            <h2>Bem-vindo, <?php echo '<span class="text-primary">'.$nomeUsuario.'</span>'; ?>!</h2>
        </div>
                ...
                <tr>
                    ...
                    <td>
                        <a class='btn btn-sm btn-warning text-white'
                            href='editar_produto.php?id_produto=<?php echo $row['id_produto']; ?>' data-toggle='tooltip' data-placement='top' title='Editar'>
                            <i class="fa-solid fa-pen-to-square"></i>
                        </a>
                        <a class='btn btn-sm btn-danger'
                            href='excluir_produto.php?id_produto=<?php echo $row['id_produto']; ?>' data-toggle="tooltip" data-placement="top" title='Deletar'>
